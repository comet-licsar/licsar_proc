...
def SLC_copy_S1_TOPS(SLColdtab,SLCnewtab,startburst,endburst,imdir,procdir,logfile):
    ...
    In:
        ...
        startburst   number (1 to n) of first burst to be extracted
        endburst     number (1 to n) of last burst to be extracted
    ...
    """ 
    copycall = ['SLC_copy_S1_TOPS',SLColdtab,SLCnewtab,'1',str(startburst),'1',str(endburst)]
    try:
