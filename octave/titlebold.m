...
%    (or all children?)
%    TITLEBOLD(h) where h is a vector of handles, set all these to bold.
%    TITLEBOLD('text') where text is a character string, add this title
%    to the current figure and makes it bold.
...
%    thus first use title, then colorbar, then titlebold.
%    not colorbar, title, titlebold
%    
